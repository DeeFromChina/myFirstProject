...
<body>
<object id="player" height="64px" width="260px" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6"> 
...
<!-- 是否启用上下文菜单  -->
<param NAME="url" value="http://localhost:8080/myFirstProject/upload/video/Wildlife.wmv"> 
<!-- 播放的文件地址  -->
